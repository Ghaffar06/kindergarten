                                ...
                                <form action="" method="get">
                                    <div class="htc__news__inner">
                                        <div class="news__input">
                                            <input type="text" value="" name="category" class="email form-control" id="cate_search" placeholder="Enter Category Name" required>
                                        </div>
                ...
                <div class="blog__2">
                    <div class="blog__thumb">
                        <a href="blog-details.html">
                            <img src="{{asset($category->url)}}" height="304" width="370" alt="blog images">
                        </a>
                    </div>
                    <div class="blog__inner">
                        <div class="blog__hover__inner">
                            ...
                            <div class="blog__btn">
                                <a class="bl__btn" href="{{route('word.index', $category->title)}}">Start Learning</a>
