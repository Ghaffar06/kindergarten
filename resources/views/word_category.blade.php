...
<head>
    ...
    <title>Blog Grid || Junior Child Care & Shop HTML5 Template</title>
                                ...
                                <div class="dcare__twit__wrap">
                                    ...
                                    <div class="dcare__twit d-flex">
                                        ...
                                        <div class="dcare__twit__details">
                                            <p>Lorem ipsum dolor sit co<a href="#"># twitter.com?web/lnk/statement</a>
                                            </p>
                            ...
                            <div class="footer__innner">
                                <div class="dcare__twit__wrap">
                                    <ul class="sm__gallery__list d-flex flex-wrap">
                                        <li><a href="#"><img src="{{asset('images/gallery/sm-gallery/1.jpg')}}"
                                                             alt="gallery images"></a></li>
                                        <li><a href="#"><img src="{{asset('images/gallery/sm-gallery/2.jpg')}}"
                                                             alt="gallery images"></a></li>
                                        <li><a href="#"><img src="{{asset('images/gallery/sm-gallery/3.jpg')}}"
                                                             alt="gallery images"></a></li>
                                        <li><a href="#"><img src="{{asset('images/gallery/sm-gallery/4.jpg')}}"
                                                             alt="gallery images"></a></li>
                                        <li><a href="#"><img src="{{asset('images/gallery/sm-gallery/5.jpg')}}"
                                                             alt="gallery images"></a></li>
                                        <li><a href="#"><img src="{{asset('images/gallery/sm-gallery/6.jpg')}}"
                                                             alt="gallery images"></a></li>
                                        <li><a href="#"><img src="{{asset('images/gallery/sm-gallery/7.jpg')}}"
                                                             alt="gallery images"></a></li>
                                        <li><a href="#"><img src="{{asset('images/gallery/sm-gallery/8.jpg')}}"
                                                             alt="gallery images"></a></li>
                                        <li><a href="#"><img src="{{asset('images/gallery/sm-gallery/9.jpg')}}"
                                                             alt="gallery images"></a></li>
                                    </ul>
                                </div>
                            </div>
