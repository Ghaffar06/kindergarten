                        ...
                        <div class="courses__wrap" style="margin-top: -70px">
                            ...
                            <div class="courses__content">
                                <h4 style="font-size: 25pt !important">
                                    Written By: {{$item->user->name}}
                                </h4>

                            </div>
                            <a class="login-trigger" href="">Read</a></li>
                            <!-- Read Form -->
                                ...
                                <div class="accountbox">
                                    <div class="accountbox__inner">
                                        ...
                                        <div class="accountbox__login">
                                            <h4>Report By : {{$item->user->name}}</h4>


                                            <div class="row mb-3  d-flex align-items-center">
                                                <label for="email-log" class="col-md-4 col-form-label text-md-end">
                                                    <h2>{{ $item->message }}</h2>
                                                </label>
