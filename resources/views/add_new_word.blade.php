                            ...
                            <form action="{{route('word.add')}}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="single-accordion">
                                    <a class="accordion-head" data-toggle="collapse" data-parent="#checkout-accordion"
                                       href="#text-score">1. Word Text & Score</a>
                                            ...
                                            <div class="checkout-login-form">
                                                <div class="row">
                                                    <div class="input-box col-md-6 col-12 mb--20">
                                                        <label for="word_text">
                                                            Word Text:
                                                            <input id="word_text" type="text" maxlength="26" name="text"
                                                                   placeholder="less than 26 character">
                                                        </label>
                                                        @error('text')
                                                        <br>
                                                    ...
                                                    <div class="input-box col-md-6 col-12 mb--20">
                                                        <label for="score">
                                                            Score:
                                                            <input id="score" type="number" min="1" max="100"
                                                                   name='score' style="max-width: 125%; width: 125%"
                                ...
                                <div class="single-accordion">
                                    <a class="accordion-head collapsed" data-toggle="collapse"
                                       data-parent="#checkout-accordion" href="#categories">2. Categories</a>
                                                ...
                                                <div class="row">
                                                    <div
                                                        ...
                                                        <div class="dcare__btn d-flex align-items-center"
                                                            ...
                                                            <h5><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add
                                                                Category</h5>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <select onchange="reassignment()">
                                                                ...
                                                                @for($index = 1;$index<=$categories->count();$index++)
                                                                    <option
                                                                        value="{{$categories[$index - 1]->id}}">{{$categories[$index - 1]->title}}</option>
                                                                @endfor
                                                            </select>
                                                            @error('image1')
                                                            <br>
                                ...
                                <div class="single-accordion">
                                    <a class="accordion-head collapsed" data-toggle="collapse"
                                       data-parent="#checkout-accordion" href="#photo-section">3. Photos</a>
                                ...
                                <div class="single-accordion">
                                    <a class="accordion-head collapsed" data-toggle="collapse"
                                       data-parent="#checkout-accordion" href="#audio-section">4. Audios</a>
                                    <div id="audio-section" class="collapse">
                                        <div class="accordion-body payment-method fix">
                                            <div
                                                ...
                                                <div class="dcare__btn d-flex align-items-center"
                                                     onclick="add_new_audio_selector()">
                                                    <h3><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add Audio
                                                    </h3>
                                                </div>
                                            </div>
