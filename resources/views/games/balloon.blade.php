...
<div id="game-section-home" class="row container-button-game">
    <div class="col text-left pr-0">
        <button id="btn-game-section-home" type="button" data-toggle="button"
                class="btn btn-xl btn-info btn-text btn-xl-focus-none">
...
<section id="heading-section" class="container-sm">
    ...
    <div class="row">
        ...
        <div class="col-12 d-none d-md-block container-heading-main-large text-center">
            <!-- <a href="index.html"> -->
            <h1 class="heading-main">Balloon Pop<img src="{{asset('balloon/images/balloon-purple-cropped.png')}}"
                                                     alt="Purple balloon popping"> Letters</h1>
            <!-- </a> -->
        </div>
    </div>
</section>
                ...
                <div class="row">
                    <div class="col d-flex w-100 container-button">
                        ...
                        <button id="btn-mul-div-1" type="button" data-toggle="button" aria-pressed="true"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-toggle active">
                            2x, 5x, 10x
                        </button>
                        <span class="container-button"></span>
                        <button id="btn-mul-div-2" type="button" data-toggle="button"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-toggle">Mixed 1
                            to 12
                        </button>
                        <span class="container-button"></span>
                    </div>
                ...
                <div class="row">
                    <div class="col d-flex w-100 container-button">
                        ...
                        <button id="btn-mul-div-3" type="button" data-toggle="button"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">1x
                        </button>
                        <span class="container-button"></span>
                        <button id="btn-mul-div-4" type="button" data-toggle="button"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">7x
                        </button>
                        <span class="container-button"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col d-flex w-100 container-button">
                        ...
                        <button id="btn-mul-div-5" type="button" data-toggle="button"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">2x
                        </button>
                        <span class="container-button"></span>
                        <button id="btn-mul-div-6" type="button" data-toggle="button"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">8x
                        </button>
                        <span class="container-button"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col d-flex w-100 container-button">
                        ...
                        <button id="btn-mul-div-7" type="button" data-toggle="button"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">3x
                        </button>
                        <span class="container-button"></span>
                        <button id="btn-mul-div-8" type="button" data-toggle="button"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">9x
                        </button>
                        <span class="container-button"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col d-flex w-100 container-button">
                        ...
                        <button id="btn-mul-div-9" type="button" data-toggle="button"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">4x
                        </button>
                        <span class="container-button"></span>
                        <button id="btn-mul-div-10" type="button" data-toggle="button"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">10x
                        </button>
                        <span class="container-button"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col d-flex w-100 container-button">
                        ...
                        <button id="btn-mul-div-11" type="button" data-toggle="button"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">5x
                        </button>
                        <span class="container-button"></span>
                        <button id="btn-mul-div-12" type="button" data-toggle="button"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">11x
                        </button>
                        <span class="container-button"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col d-flex w-100 container-button">
                        ...
                        <button id="btn-mul-div-13" type="button" data-toggle="button"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">6x
                        </button>
                        <span class="container-button"></span>
                        <button id="btn-mul-div-14" type="button" data-toggle="button"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">12x
                        </button>
                        <span class="container-button"></span>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col d-flex w-100 container-button">
                        ...
                        <button id="btn-add-sub-1" type="button" data-toggle="button" aria-pressed="true"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-add-sub-toggle active">
                            Mixed to 10
                        </button>
                        <span class="container-button"></span>
                        <button id="btn-add-sub-2" type="button" data-toggle="button"
                                class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-add-sub-toggle">Mixed to
                            20
                        </button>
                        <span class="container-button"></span>
                    </div>
...
<section id="information-section" class="container-sm" aria-label="Information Section">
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="container-button-group d-flex w-100">
                <button type="button" data-toggle="collapse" data-target="#information" aria-expanded="false"
                        aria-controls="information" class="btn btn-xl w-100 btn-info btn-text">How To Play
                </button>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8">
            ...
            <div class="container-text-information">
                <p class="text-information">
                    Balloon Pop Maths is a fun and engaging interactive maths game designed to help reinforce maths
                    skills,
                    ...
                    Specific groups of questions may also be selected to assist with targeted learning. Please feel free
                    to
                    <a href="#modal-contact" data-toggle="modal"
                       data-target="#modal-contact"><strong>contact</strong></a>
                    me with suggestions on how I can improve Ballon Pop Maths, or if you need a developer to make your
                    ideas reality!
                </p>
            </div>
        </div>
            ...
            <div class="col-lg-6 p-0 m-0">
                <div class="row canvas-balloon p-0 m-0">
                    <div class="col d-flex justify-content-center p-0 m-0">
                        ...
                        <div id="balloon-answer-text-left-1" class="balloon-answer-text balloon-answer-text-top"><img
                                src="DSC_0209.jpg"></div>
                    </div>
                    <div class="col d-flex justify-content-center p-0 m-0">
                        <canvas id="canvas-balloon-left-2"></canvas>
                        <div id="balloon-answer-text-left-2" class="balloon-answer-text balloon-answer-text-bottom"><img
                                src="DSC_0209.jpg"></div>
                    </div>
                </div>
                <div class="row canvas-balloon p-0 m-0">
                    <div class="col d-flex justify-content-center p-0 m-0">
                        ...
                        <div id="balloon-answer-text-left-3" class="balloon-answer-text balloon-answer-text-top"><img
                                src="DSC_0209.jpg"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 p-0 m-0">
                <div class="row canvas-balloon p-0 m-0">
                    <div class="col d-flex justify-content-center p-0 m-0">
                        ...
                        <div id="balloon-answer-text-right-1" class="balloon-answer-text balloon-answer-text-top"><img
                                src="DSC_0209.jpg"></div>
                    </div>
                    <div class="col d-flex justify-content-center p-0 m-0">
                        <canvas id="canvas-balloon-right-2"></canvas>
                        <div id="balloon-answer-text-right-2" class="balloon-answer-text balloon-answer-text-bottom">
                            <img src="DSC_0209.jpg"></div>
                    </div>
                </div>
                <div class="row canvas-balloon p-0 m-0">
                    <div class="col d-flex justify-content-center p-0 m-0">
                        <canvas id="canvas-balloon-right-3"></canvas>
                        <div id="balloon-answer-text-right-3" class="balloon-answer-text balloon-answer-text-top"><img
                                src="DSC_0209.jpg"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="contact" onsubmit="return sendMail(this);">
                    <p>Please feel free to contact me with suggestions on how I can improve Balloon Pop Maths, or if you
                        need a developer to make your ideas reality! </p>
                    ...
                    <div class="form-group">
                        <textarea class="form-control" id="message" name="message" placeholder="Enter message"
                                  aria-label="Enter message" maxlength="6000" rows="7" required></textarea>
                    </div>
