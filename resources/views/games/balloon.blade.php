...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('balloon/images/balloon-favicon.ico')}}" type="image/x-icon">
    ...
    <!-- Link to Custom CSS -->
    <link rel="stylesheet" href="{{asset('balloon/css/style.css')}}">
    <!-- Link to Email JS -->
...
<body>
        ...
        <div class="row">
            ...
            <div class="col-12 d-md-none container-heading-main text-center">
                ...
                <h1 class="heading-main">Pop
                    <img src="{{asset('balloon/images/balloon-purple-cropped.png')}}" alt="Purple balloon popping" />
                </h1>
                <h1 class="heading-main">Letters</h1>

            </div>
            <!-- Screens larger than md -->
            <div class="col-12 d-none d-md-block container-heading-main-large text-center">
                <!-- <a href="index.html"> -->
                <h1 class="heading-main">Balloon Pop<img src="{{asset('balloon/images/balloon-purple-cropped.png')}}" alt="Purple balloon popping"> Letters</h1>
                <!-- </a> -->
            </div>
        </div>
    </section>
            ...
            <div class="col-md-8">
                ...
                <div id="options-multiply-divide">
                    <div class="row">
                        <div class="col d-flex w-100 container-button">
                            ...
                            <button id="btn-mul-div-1" type="button" data-toggle="button" aria-pressed="true" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-toggle active">2x, 5x, 10x</button>
                            <span class="container-button"></span>
                            <button id="btn-mul-div-2" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-toggle">Mixed 1 to 12</button>
                            <span class="container-button"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col d-flex w-100 container-button">
                            <span class="container-button"></span>
                            <button id="btn-mul-div-3" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">1x</button>
                            <span class="container-button"></span>
                            <button id="btn-mul-div-4" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">7x</button>
                            <span class="container-button"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col d-flex w-100 container-button">
                            <span class="container-button"></span>
                            <button id="btn-mul-div-5" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">2x</button>
                            <span class="container-button"></span>
                            <button id="btn-mul-div-6" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">8x</button>
                            <span class="container-button"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col d-flex w-100 container-button">
                            <span class="container-button"></span>
                            <button id="btn-mul-div-7" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">3x</button>
                            <span class="container-button"></span>
                            <button id="btn-mul-div-8" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">9x</button>
                            <span class="container-button"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col d-flex w-100 container-button">
                            <span class="container-button"></span>
                            <button id="btn-mul-div-9" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">4x</button>
                            <span class="container-button"></span>
                            <button id="btn-mul-div-10" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">10x</button>
                            <span class="container-button"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col d-flex w-100 container-button">
                            <span class="container-button"></span>
                            <button id="btn-mul-div-11" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">5x</button>
                            <span class="container-button"></span>
                            <button id="btn-mul-div-12" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">11x</button>
                            <span class="container-button"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col d-flex w-100 container-button">
                            <span class="container-button"></span>
                            <button id="btn-mul-div-13" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">6x</button>
                            <span class="container-button"></span>
                            <button id="btn-mul-div-14" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-mul-div-sticky">12x</button>
                            <span class="container-button"></span>
                        </div>
                    </div>
                </div>
                <div id="options-add-subtract">
                    <div class="row">
                        <div class="col d-flex w-100 container-button">
                            <span class="container-button"></span>
                            <button id="btn-add-sub-1" type="button" data-toggle="button" aria-pressed="true" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-add-sub-toggle active">Mixed to 10</button>
                            <span class="container-button"></span>
                            <button id="btn-add-sub-2" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-add-sub-toggle">Mixed to 20</button>
                            <span class="container-button"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col d-flex w-100 container-button">
                            <span class="container-button"></span>
                            <button id="btn-add-sub-3" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-add-sub-toggle">Mixed to 50</button>
                            <span class="container-button"></span>
                            <button id="btn-add-sub-4" type="button" data-toggle="button" class="btn btn-xl w-100 btn-info btn-text btn-xl-focus-none btn-add-sub-toggle">Mixed to 100</button>
                            <span class="container-button"></span>
                        </div>
                    </div>
                </div>
    ...
    <section id="game-section" class="container-xl d-none" aria-label="Game Section">
        ...
        <div id="game-section-home" class="row container-button-game">
            <div class="col text-left pr-0">
                <button id="btn-game-section-home" type="button" data-toggle="button" class="btn btn-xl btn-info btn-text btn-xl-focus-none">Home
                </button>
            </div>
            <div class="col text-right pl-0">
                <div id="score" class="btn btn-xl-nofill btn-text-score d-none">Score: 0 / 20</div>
        ...
        <div id="game-canvas-controls" class="d-none">
                ...
                <div class="col-lg-6 p-0 m-0">
                    <div class="row canvas-balloon p-0 m-0">
                        <div class="col d-flex justify-content-center p-0 m-0">
                            ...
                            <div id="balloon-answer-text-left-1" class="balloon-answer-text balloon-answer-text-top"><img src="DSC_0209.jpg"></div>
                        </div>
                        <div class="col d-flex justify-content-center p-0 m-0">
                            <canvas id="canvas-balloon-left-2"></canvas>
                            <div id="balloon-answer-text-left-2" class="balloon-answer-text balloon-answer-text-bottom"><img src="DSC_0209.jpg"></div>
                        </div>
                    </div>
                    <div class="row canvas-balloon p-0 m-0">
                        <div class="col d-flex justify-content-center p-0 m-0">
                            <canvas id="canvas-balloon-left-3"></canvas>
                            <div id="balloon-answer-text-left-3" class="balloon-answer-text balloon-answer-text-top"><img src="DSC_0209.jpg"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 p-0 m-0">
                    <div class="row canvas-balloon p-0 m-0">
                        <div class="col d-flex justify-content-center p-0 m-0">
                            ...
                            <div id="balloon-answer-text-right-1" class="balloon-answer-text balloon-answer-text-top"><img src="DSC_0209.jpg"></div>
                        </div>
                        <div class="col d-flex justify-content-center p-0 m-0">
                            <canvas id="canvas-balloon-right-2"></canvas>
                            <div id="balloon-answer-text-right-2" class="balloon-answer-text balloon-answer-text-bottom"><img src="DSC_0209.jpg"></div>
                        </div>
                    </div>
                    <div class="row canvas-balloon p-0 m-0">
                        <div class="col d-flex justify-content-center p-0 m-0">
                            <canvas id="canvas-balloon-right-3"></canvas>
                            <div id="balloon-answer-text-right-3" class="balloon-answer-text balloon-answer-text-top"><img src="DSC_0209.jpg"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row game-section-controls p-0 m-0">
                ...
                <div class="col-lg-4">
                    <div id="question"><img src="DSC_0209.png" id="question_img" width="200" height="200"></div>
                </div>
                <div class="col-lg-4">
                </div>
            </div>
    ...
    <!-- <footer class="container-sm">
        <div class="container-footer">
            <a href="#modal-contact" data-toggle="modal" data-target="#modal-contact">Contact Developer</a>
            <a href="https://github.com/richardhenyash" aria-label="Link to developer GitHub page" rel="noreferrer noopener" target="_blank"><i class="fab fa-github-square fa-lg"></i></a>
        </div>
    </footer> -->
    <!-- JavaScript links -->
    ...
    <script src="{{asset('balloon/js/initialisation.js')}}"></script>
