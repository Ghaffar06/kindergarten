...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('number/images/balloon-favicon.ico')}}" type="image/x-icon">
    ...
    <!-- Link to Custom CSS -->
    <link rel="stylesheet" href="{{asset('number/css/style.css')}}">
    <!-- Link to Email JS -->
...
<div id="game-section-home" class="row container-button-game">
    ...
    <section id="heading-section" class="container-sm">
        ...
        <div class="row">
            ...
            <div class="col-12 d-md-none container-heading-main text-center">
                <a href="index.html">
                    ...
                    <h1 class="heading-main">Pop
                        <img src="{{asset('number/images/balloon-purple-cropped.png')}}" alt="Purple balloon popping"/>
                    </h1>
            ...
            <div class="col-12 d-none d-md-block container-heading-main-large text-center">
                <a href="index.html">
                    <h1 class="heading-main">Balloon Pop<img src="{{asset('number/images/balloon-purple-cropped.png')}}" alt="Purple balloon popping"> Maths</h1>
                </a>
            </div>
        </div>
    </section>
    ...
    <script src="{{asset('number/js/initialisation.js')}}"></script>
    <script src="{{asset('number/js/audio.js')}}"></script>
    <script src="{{asset('number/js/animation.js')}}"></script>
    <script src="{{asset('number/js/display.js')}}"></script>
    <script src="{{asset('number/js/game-logic.js')}}"></script>
    <script src="{{asset('number/js/mail.js')}}"></script>
    <script src="{{asset('number/js/maths.js')}}"></script>
    <script src="{{asset('number/js/events.js')}}"></script>
