                    ...
                    <div class="class__thumb">
                        <div class="rounded border border-warning p-1"
                            ...
                            <div class="slide__carosel owl-carousel owl-theme">
                                ...
                                <div class="slider__area d-flex fullscreen justify-content-center align-items-center">
                                    <div class="courses__images">
                                        <img height="650px" src="{{asset('images/category/family.png')}}" alt="class images">
                                    </div>
                                </div>
                                @endfor
                                <div class="slider__area d-flex fullscreen justify-content-center align-items-center">
                                    <div class="courses__images">
                                        <img  height="650px" src="{{asset('images/category/number.png')}}../words imgs, voice/words imgs, voice/family/family.png" alt="class images">
                                    </div>
                                </div>
                            </div>
                        </div>
